...
MoDisco - этим плагином генерировать .xmi файл и UML , а UML Disainer 5.0 уже из UML строит диаграмму пакетов, он и диаграмму классов сможет посмтроить , если xmi файл MoDisco более расширеный сгенерировать 
